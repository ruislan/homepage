...
async function getTopViewPosts() {
...
export default async function Page() {
  const posts = await getTopViewPosts();

  return (
    <div>
      <h1 className='font-bold text-2xl mb-8'>Hi，大家好，我是 Rui  👏</h1>
      <Paragraph>
        一个 80 后开发者，乐观主义者，向往一切美好的事物。最近一段时间比较喜欢且最常用的技术栈是 NodeJS，Fastify，Prisma，React，NextJS。并不断尝试用这套组合去实现各种有意思的项目。
      </Paragraph>
